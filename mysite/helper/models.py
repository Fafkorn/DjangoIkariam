...
class UserHistory(models.Model):
    ...
    master_builders = models.IntegerField(null=True, default=-1)
    building_levels = models.IntegerField(null=True, default=-1)
    scientists = models.IntegerField(null=True, default=-1)
    research_level = models.IntegerField(null=True, default=-1)
    generals = models.IntegerField(null=True, default=-1)
    gold = models.BigIntegerField(null=True, default=-1)
    offensive = models.IntegerField(null=True, default=-1)
    defensive = models.IntegerField(null=True, default=-1)
    trading = models.IntegerField(null=True, default=-1)
    resources = models.IntegerField(null=True, default=-1)
    donations = models.IntegerField(null=True, default=-1)
    piracy = models.IntegerField(null=True, default=-1)
