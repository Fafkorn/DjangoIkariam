...
class UserHistory(models.Model):
    ...
    master_builders = models.IntegerField(null=True, blank=True, default=None)
    building_levels = models.IntegerField(null=True, blank=True, default=None)
    scientists = models.IntegerField(null=True, blank=True, default=None)
    research_level = models.IntegerField(null=True, blank=True, default=None)
    generals = models.IntegerField(null=True, blank=True, default=None)
    gold = models.BigIntegerField(null=True, blank=True, default=None)
    offensive = models.IntegerField(null=True, blank=True, default=None)
    defensive = models.IntegerField(null=True, blank=True, default=None)
    trading = models.IntegerField(null=True, blank=True, default=None)
    resources = models.IntegerField(null=True, blank=True, default=None)
    donations = models.IntegerField(null=True, blank=True, default=None)
    piracy = models.IntegerField(null=True, blank=True, default=None)
