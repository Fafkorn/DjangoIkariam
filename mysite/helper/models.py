...
class UserHistory(models.Model):
    ...
    score = models.IntegerField(null=True, blank=True, default='')
    master_builders = models.IntegerField(null=True, blank=True, default='')
    ...
    trading = models.IntegerField(null=True, blank=True, default='')
    resources = models.IntegerField(null=True, blank=True, default='')
    donations = models.IntegerField(null=True, blank=True, default='')
    piracy = models.IntegerField(null=True, blank=True, default='')


class UserStatisticsHistory(models.Model):
    time = models.DateTimeField()

    active_users = models.IntegerField(null=True, blank=True, default='')
    inactive_users = models.IntegerField(null=True, blank=True, default='')
    on_vacation_users = models.IntegerField(null=True, blank=True, default='')
    deleted_users = models.IntegerField(null=True, blank=True, default='')
